...
<template>
  <main>
    <div class="left-box">
      <img src="../assets/logo-villa-dolce.jpeg" alt="logo">
    </div>
      ...
      <form @submit.prevent="handleLogin">
        ...
        <div class="input-field">
          <div class="input-centralize">
            <input v-model="cellphone" type="text" maxlength="20" placeholder="" required>
            <label for="cellphone">Telefone</label>
          </div>

          <div class="input-centralize">
            <input v-model="password" :type="passwordFieldType" maxlength="20" placeholder="" required>
