...
from database.crud.categoria import (
    create_categoria,
    get_categoria_by_id,
    get_all_categorias,
    update_categoria,
...
def create_category(data: CreateCategoryRequest):
    ...
    try:
        ...
        return JSONResponse(
            status_code=status.HTTP_201_CREATED,
            content={
                "uuid": str(categoria.idCategoria),
                "Nome": categoria.nome,
                "Unidade de Medida": categoria.unidadeMedida,
            },
        )
        ...
        return JSONResponse(
            ...
            content={"message": "Erro ao criar a categoria"},
        )


@router.get(
    "/get_category/{idCategoria}",
    ...
    try:
        ...
        if categoria is None:
            return JSONResponse(
                ...
                content={"message": "Categoria não encontrada"},
            )
        ...
        return JSONResponse(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            content={"message": "Erro ao buscar a categoria"},
        )
...
def get_all_categories():
    try:
        ...
        return JSONResponse(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            content={"message": "Erro ao buscar as categorias"},
        )
...
def update_category(idCategoria: str, data: UpdateCategoryRequest):
    try:
        ...
        if categoria is None:
            return JSONResponse(
                status_code=status.HTTP_400_BAD_REQUEST,
                content={"message": "Categoria não encontrada ou não atualizada"},
            )
        ...
        return JSONResponse(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            content={"message": "Erro ao atualizar a categoria"},
        )


@router.delete(
    "/delete_category/{idCategoria}",
    status_code=status.HTTP_200_OK,
    dependencies=[Depends(get_token_header)],
)
def delete_category(idCategoria: str):
    try:
        ...
        if categoria is None:
            return JSONResponse(
                status_code=status.HTTP_400_BAD_REQUEST,
                content={"message": "Categoria não encontrada ou não deletada"},
            )
        ...
        return JSONResponse(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            content={"message": "Erro ao deletar a categoria"},
        )
